...
1 0.02 200 0.02 1.0 10 10 -10 -4.53 5.64 0 
2 0.02 200 0.02 1.0 10 10 -10 -4.53 5.64 0 
3 0.02 200 0.02 1.0 10 10 -10 -4.53 5.64 0 
...
```data title="ge.dat"
1  0.2000  0.0330  0.0264  8.00  0.05  0.190   0.061  0.03   .4   0.04   54.000   0     
2  0.2000  0.0330  0.0264  8.00  0.05  0.190   0.061  0.03   .4   0.04   54.000   0     
3  0.2000  0.0330  0.0264  8.00  0.05  0.190   0.061  0.03   .4   0.04   63.000   0     
4  0.2000  0.0330  0.0264  8.00  0.05  0.190   0.061  0.03   .4   0.04   63.000   0     
```


```data title="gen00.dat"
1  0.2000  0.0330  .033  1000000  .05  0.033   .033  0.033   .4   .04   54.000   0     
2  0.2000  0.0330  .033  1000000  .05  0.033   .033  0.033   .4   .04   54.000   0     
3  0.2000  0.0330  .033  1000000  .05  0.033   .033  0.033   .4   .04   63.000   0     
4  0.2000  0.0330  .033  1000000  .05  0.033   .033  0.033   .4   .04   63.000   0    
```


```data title="gen11.dat"
1  0.2000  0.0330  0.033  8.00  .05  0.190   0.061  0.061   .4   .04   54.000   0     
2  0.2000  0.0330  0.033  8.00  .05  0.190   0.061  0.061   .4   .04   54.000   0     
3  0.2000  0.0330  0.033  8.00  .05  0.190   0.061  0.061   .4   .05   63.000   0     
4  0.2000  0.0330  0.033  8.00  .05  0.190   0.061  0.061   .4   .04   63.000   0     
```
...
```data title="Id.dat"
   9      11.590000    2.120000 
  10      15.750000    2.880000 
```

```data title="LFL.dat"
  1 	     1.030000 	    8.215523	    7.000000	    1.338523	 0.000000	 0.000000 
  2 	     1.010000 	   -1.503809	    7.000000	    1.591791	 0.000000	 0.000000 
  3 	     1.030000 	    0.000000	    7.217178	    1.446427	 0.000000	 0.000000 
  4 	     1.010000 	  -10.204916	    7.000000	    1.807834	 0.000000	 0.000000 
  5 	     1.010800 	    3.661654	    0.000000	    0.000000	 0.000000	 0.000000 
  6 	     0.987533 	   -6.243121	    0.000000	    0.000000	 0.000000	 0.000000 
  7 	     1.009533 	   -4.697706	    0.000000	    0.000000	 0.000000	 0.000000 
  8 	     0.984958 	  -14.944164	    0.000000	    0.000000	 0.000000	 0.000000 
  9 	     0.976120 	  -14.419101	    0.000000	    0.000000	11.590000	 2.120000 
 10 	     0.971659 	  -23.291847	    0.000000	    0.000000	15.750000	 2.880000 
```


```c title="LFl_Result.m"
...
```datat title="Power_Pss.data"
1 10 0.05 0.03 0.1 -0.1
2 10 0.05 0.07 0.1 -0.1
3 10 0.05 0.07 0.1 -0.1
4 10 0.05 0.03 0.1 -0.1
```


```c title="Power_Pss_Setting.m"
...
Iter. No = 1 Max. Real power mismatch at bus = 10, Max. mismatch = 0.71562584
Iter. No = 1 Max. Reactive power mismatch at bus = 10, Max. mismatch = 0.19762315
Iter. No = 2 Max. Real power mismatch at bus = 10, Max. mismatch = 0.15626431
Iter. No = 2 Max. Reactive power mismatch at bus = 10, Max. mismatch = 0.04381344
Iter. No = 3 Max. Real power mismatch at bus = 10, Max. mismatch = 0.03096012
Iter. No = 3 Max. Reactive power mismatch at bus = 10, Max. mismatch = 0.00881821
Iter. No = 4 Max. Real power mismatch at bus = 10, Max. mismatch = 0.00608600
Iter. No = 4 Max. Reactive power mismatch at bus = 10, Max. mismatch = 0.00173999
Iter. No = 5 Max. Real power mismatch at bus = 10, Max. mismatch = 0.00118549
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Converged Real power mismatch iteration No = 6, Max.mismatch = 0.00005917
Converged Reactive power mismatch iteration No = 5, Max. mismatch = 0.00033958
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 Loadflow results:
---------------------------------------------------------------------------------------
...
----------------------------------------------------------------------------------
  9 	  10	       0.6654	      -0.1524	  10	    9	      -0.6552	      -0.0584
  9 	  10	       0.6654	      -0.1524	  10	    9	      -0.6552	      -0.0584
  9 	  10	       0.6654	      -0.1524	  10	    9	      -0.6552	      -0.0584
  9 	   6	      -6.7931	       0.5978	   6	    9	       6.8908	       0.3497
  9 	   6	      -6.7931	       0.5978	   6	    9	       6.8908	       0.3497
 10 	   8	      -6.8921	       0.5360	   8	   10	       6.9934	       0.4480
 10 	   8	      -6.8921	       0.5360	   8	   10	       6.9934	       0.4480
  5 	   6	       3.4761	       0.3820	   6	    5	      -3.4161	       0.1431
  5 	   6	       3.4761	       0.3820	   6	    5	      -3.4161	       0.1431
  7 	   8	       3.5830	       0.4168	   8	    7	      -3.5190	       0.1486
  7 	   8	       3.5830	       0.4168	   8	    7	      -3.5190	       0.1486
  1 	   5	       7.0000	       1.3385	   5	    1	      -6.9521	      -0.7640
  2 	   6	       7.0000	       1.5918	   6	    2	      -6.9495	      -0.9856
  3 	   7	       7.2172	       1.4464	   7	    3	      -7.1661	      -0.8336
  4 	   8	       7.0000	       1.8078	   8	    4	      -6.9488	      -1.1930
----------------------------------------------------------------------------------
Total real power losses in the system =  0.877206
Total reactive power losses in the system =  1.185332
```
...
1 15 0.02 10 0.07577  0.03715  0.1  -0.1  570  35  1
```


```c title="Slip_pss_setting.m"
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
%        FORMATION OF A MATRIX with PSS
